...
<div class="row">
    ...
    <div class="col-md-4 col-sm-10 col-xs-12 col-md-offset-1 col-sm-offset-1 col-xs-offset-0" style="background-color:#ddd">
          ...
          <div id="courseMain"> <h4 align="center" id="courseHeader">Basic Course</h4> </div> 
          <br>
     ...
     <div class="col-md-6 hidden-sm hidden-xs col-md-offset-0 col-sm-offset-1 col-xs-offset-0" style="background-color:#eee">
