...
{{-- 
    <style>
        .hero-content {
            background: url("{{asset('public/images/hero-bg.jpg')}}") no-repeat center;
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="course-content flex flex-wrap justify-content-between align-content-lg-stretch">
                        <figure class="course-thumbnail">
                            <a href="#"><img src="{{asset('public/images/1.jpg')}}" alt=""></a>
                ...
                <div class="col-12 col-lg-6">
                    <div class="course-content flex flex-wrap justify-content-between align-content-lg-stretch">
                        <figure class="course-thumbnail">
                            <a href="#"><img src="{{asset('public/images/2.jpg')}}" alt=""></a>
                        </figure><!-- .course-thumbnail -->
        ...
        <div class="container">
            <div class="row mx-m-25">
                ...
                <div class="col-12 col-md-6 col-lg-4 px-25">
                    <div class="course-content">
                        <figure class="course-thumbnail">
                            <a href="#"><img src="{{asset('public/images/3.jpg')}}" alt=""></a>
                        </figure><!-- .course-thumbnail -->
                ...
                <div class="col-12 col-md-6 col-lg-4 px-25">
                    <div class="course-content">
                        <figure class="course-thumbnail">
                            <a href="#"><img src="{{asset('public/images/4.jpg')}}" alt=""></a>
                        </figure><!-- .course-thumbnail -->
                ...
                <div class="col-12 col-md-6 col-lg-4 px-25">
                    <div class="course-content">
                        <figure class="course-thumbnail">
                            <a href="#"><img src="{{asset('public/images/5.jpg')}}" alt=""></a>
                        </figure><!-- .course-thumbnail -->
                ...
                <div class="col-12 col-md-6 col-lg-4 px-25">
                    <div class="course-content">
                        <figure class="course-thumbnail">
                            <a href="#"><img src="{{asset('public/images/6.jpg')}}" alt=""></a>
                        </figure><!-- .course-thumbnail -->
    ...
    <section class="home-gallery">
        <div class="gallery-wrap flex flex-wrap">
            <div class="gallery-grid gallery-grid1x1">
                <a href="#"><img src="{{asset('public/images/a.jpg')}}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid1x1">
                <a href="#"><img src="{{asset('public/images/b.jpg')}}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid2x2">
                <a href="#"><img src="{{asset('public/images/c.jpg')}}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid1x1">
                <a href="#"><img src="{{asset('public/images/d.jpg')}}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid1x1">
                <a href="#"><img src="{{asset('public/images/e.jpg')}}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid2x1">
                <a href="#"><img src="{{asset('public/images/g.jpg')}}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid2x1">
                <a href="#"><img src="{{asset('public/images/h.jpg')}}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid1x1">
                <a href="#"><img src="{{asset('public/images/i.jpg')}}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid2x2 ">
                <a href="#"><img src="{{asset('public/images/j.jpg')}}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid1x1">
                <a href="#"><img src="{{asset('public/images/k.jpg')}}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid1x1">
                <a href="#"><img src="{{asset('public/images/l.jpg')}}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid2x1">
                <a href="#"><img src="{{asset('public/images/m.jpg')}}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid3x1">
                <a href="#"><img src="{{asset('public/images/n.jpg')}}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid1x1">
                <a href="#"><img src="{{asset('public/images/o.jpg')}}" alt=""></a>
            </div><!-- .gallery-grid -->
        </div><!-- .gallery-wrap -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 flex flex-wrap justify-content-center justify-content-lg-between align-items-center">
                    <div class="logo-wrap">
                        <img src="{{asset('public/images/logo-1.png')}}" alt="">
                    </div><!-- .logo-wrap -->
                    ...
                    <div class="logo-wrap">
                        <img src="{{asset('public/images/logo-3.png')}}" alt="">
                    </div><!-- .logo-wrap -->

                    <div class="logo-wrap">
                        <img src="{{asset('public/images/logo-4.png')}}" alt="">
                    </div><!-- .logo-wrap -->

                    <div class="logo-wrap">
                        <img src="{{asset('public/images/logo-5.png')}}" alt="">
                    </div><!-- .logo-wrap -->
                </div><!-- .col -->
            </div><!-- .row -->
        </div><!-- .container -->
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="foot-about">
                            <a class="foot-logo" href="#"><img src="{{asset('public/images/foot-logo.png')}}" alt=""></a>
