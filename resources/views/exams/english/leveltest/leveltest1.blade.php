...
<html lang="en">
  <head>
    ...
    <title>Calamus Education(Easy English) level test</title>
    <style>
        *{
  ...
  <body onload="initialLoad();">
    <div class="container">
        <h1>Easy English-Calamus Education<br>
            Level Test<br>
            General English
            </h1>
            <h2>This level test includes 25 questions to test your English Level. 
                Please do not use dictionary, google and other materials for the exam.
                </h2>
                <form action="{{route('checkEnglishLevelTestOne',$userid)}}" method="POST" id="form1">
                @csrf
                </form>
    </div>
